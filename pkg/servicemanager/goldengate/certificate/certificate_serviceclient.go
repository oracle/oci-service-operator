...
type CertificateServiceClient interface {
	CreateOrUpdate(context.Context, *goldengatev1beta1.Certificate, ctrl.Request) (servicemanager.OSOKResponse, error)
	Delete(context.Context, *goldengatev1beta1.Certificate) (bool, error)
}

type defaultCertificateServiceClient struct {
	generatedruntime.ServiceClient[*goldengatev1beta1.Certificate]
}
...
var newCertificateServiceClient = func(manager *CertificateServiceManager) CertificateServiceClient {
	...
	delegate := defaultCertificateServiceClient{
		ServiceClient: generatedruntime.NewServiceClient[*goldengatev1beta1.Certificate](config),
	}
