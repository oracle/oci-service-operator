...
type VcnServiceManager struct {
	...
	client VcnServiceClient
}

var _ servicemanager.OSOKServiceManager = (*VcnServiceManager)(nil)

func NewVcnServiceManagerWithDeps(deps servicemanager.RuntimeDeps) *VcnServiceManager {
	...
	manager.client = newVcnServiceClient(manager)
	return manager
}
...
func NewVcnServiceManager(provider common.ConfigurationProvider, credClient credhelper.CredentialClient,
	...
	return NewVcnServiceManagerWithDeps(servicemanager.RuntimeDeps{
		Provider:         provider,
...
func (c *VcnServiceManager) WithClient(client VcnServiceClient) *VcnServiceManager {
	if client != nil {
		c.client = client
	}
	return c
...
func (c *VcnServiceManager) convert(obj runtime.Object) (*corev1beta1.Vcn, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected *corev1beta1.Vcn, got %T", obj)
	}
	return resource, nil
}

func (c *VcnServiceManager) status(resource *corev1beta1.Vcn) *shared.OSOKStatus {
