...
var _ servicemanager.OSOKServiceManager = (*StreamServiceManager)(nil)
...
func NewStreamServiceManagerWithDeps(deps servicemanager.RuntimeDeps) *StreamServiceManager {
	...
	manager.client = newStreamServiceClient(manager)
	return manager
}
...
func (c *StreamServiceManager) WithClient(client StreamServiceClient) *StreamServiceManager {
	if client != nil {
		c.client = client
	}
	return c
...
func (c *StreamServiceManager) convert(obj runtime.Object) (*streamingv1beta1.Stream, error) {
	resource, ok := obj.(*streamingv1beta1.Stream)
	if !ok {
		return nil, fmt.Errorf("expected *streamingv1beta1.Stream, got %T", obj)
	}
	return resource, nil
}

func (c *StreamServiceManager) status(resource *streamingv1beta1.Stream) *shared.OSOKStatus {
