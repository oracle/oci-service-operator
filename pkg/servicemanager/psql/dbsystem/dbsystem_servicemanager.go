...
func (c *DbSystemServiceManager) convert(obj runtime.Object) (*psqlv1beta1.DbSystem, error) {
	resource, ok := obj.(*psqlv1beta1.DbSystem)
	if !ok {
		return nil, fmt.Errorf("expected *psqlv1beta1.DbSystem, got %T", obj)
	}
	return resource, nil
}

func (c *DbSystemServiceManager) status(resource *psqlv1beta1.DbSystem) *shared.OSOKStatus {
