...
func TestConvert_IG_Rule_To_Rule_Details(t *testing.T) {
	type args struct {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantRuleDetails: []sdk.IngressGatewayTrafficRouteRuleDetails{
				...
				sdk.TcpIngressGatewayTrafficRouteRuleDetails{
					Destinations: []sdk.VirtualServiceTrafficRuleTargetDetails{
						{
							VirtualServiceId: String("my-vs-id-1"),
							Port:             Integer(9080),
				...
				sdk.TlsPassthroughIngressGatewayTrafficRouteRuleDetails{
					Destinations: []sdk.VirtualServiceTrafficRuleTargetDetails{
						{
							VirtualServiceId: String("my-vs-id-2"),
							Port:             Integer(9080),
