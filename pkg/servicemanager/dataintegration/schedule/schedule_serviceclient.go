...
type ScheduleServiceClient interface {
	CreateOrUpdate(context.Context, *dataintegrationv1beta1.Schedule, ctrl.Request) (servicemanager.OSOKResponse, error)
	Delete(context.Context, *dataintegrationv1beta1.Schedule) (bool, error)
}

type defaultScheduleServiceClient struct {
	generatedruntime.ServiceClient[*dataintegrationv1beta1.Schedule]
}
...
var newScheduleServiceClient = func(manager *ScheduleServiceManager) ScheduleServiceClient {
	...
	delegate := defaultScheduleServiceClient{
		ServiceClient: generatedruntime.NewServiceClient[*dataintegrationv1beta1.Schedule](config),
	}
