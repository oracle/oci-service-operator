...
type ApplicationServiceClient interface {
	CreateOrUpdate(context.Context, *dataintegrationv1beta1.Application, ctrl.Request) (servicemanager.OSOKResponse, error)
	Delete(context.Context, *dataintegrationv1beta1.Application) (bool, error)
}

type defaultApplicationServiceClient struct {
	generatedruntime.ServiceClient[*dataintegrationv1beta1.Application]
}
...
var newApplicationServiceClient = func(manager *ApplicationServiceManager) ApplicationServiceClient {
	...
	delegate := defaultApplicationServiceClient{
		ServiceClient: generatedruntime.NewServiceClient[*dataintegrationv1beta1.Application](config),
	}
