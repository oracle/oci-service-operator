...
var _ servicemanager.OSOKServiceManager = (*DbSystemServiceManager)(nil)
...
func NewDbSystemServiceManagerWithDeps(deps servicemanager.RuntimeDeps) *DbSystemServiceManager {
	...
	manager.client = newDbSystemServiceClient(manager)
	return manager
}

func NewDbSystemServiceManager(provider common.ConfigurationProvider, credClient credhelper.CredentialClient,
	scheme *runtime.Scheme, log loggerutil.OSOKLogger, metrics *metrics.Metrics) *DbSystemServiceManager {
...
func (c *DbSystemServiceManager) convert(obj runtime.Object) (*databasev1beta1.DbSystem, error) {
	resource, ok := obj.(*databasev1beta1.DbSystem)
	if !ok {
		return nil, fmt.Errorf("expected *databasev1beta1.DbSystem, got %T", obj)
	}
	return resource, nil
}

func (c *DbSystemServiceManager) status(resource *databasev1beta1.DbSystem) *shared.OSOKStatus {
