...
func newAutonomousDatabaseDefaultRuntimeHooks(sdkClient databasesdk.DatabaseClient) AutonomousDatabaseRuntimeHooks {
	return AutonomousDatabaseRuntimeHooks{
		...
		Delete: runtimeOperationHooks[databasesdk.DeleteAutonomousDatabaseRequest, databasesdk.DeleteAutonomousDatabaseResponse]{
			Fields: []generatedruntime.RequestField{{FieldName: "AutonomousDatabaseId", RequestName: "autonomousDatabaseId", Contribution: "path", PreferResourceID: true}, {FieldName: "MustDeleteAssociatedLongTermBackups", RequestName: "mustDeleteAssociatedLongTermBackups", Contribution: "query", PreferResourceID: false}},
