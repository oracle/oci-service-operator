...
func applyApplicationRuntimeHooks(hooks *ApplicationRuntimeHooks) {
	if hooks == nil {
		return
	}
	getCall := hooks.Get.Call
	mutableFields := []string{"type", "icmpType", "icmpCode"}
	hooks.Semantics = policychildruntime.Semantics("application", mutableFields)
	hooks.BuildUpdateBody = func(_ context.Context, resource *networkfirewallv1beta1.Application, _ string, currentResponse any) (any, bool, error) {
		return policychildruntime.FullUpdateBody(resource.Spec, currentResponse, mutableFields)
	}
	hooks.Identity = generatedruntime.IdentityHooks[*networkfirewallv1beta1.Application]{
		RecordBeforeCreateFollowUp: true,
		Resolve: func(resource *networkfirewallv1beta1.Application) (any, error) {
		...
		RecordPath: func(resource *networkfirewallv1beta1.Application, value any) {
		...
		RecordTracked: func(resource *networkfirewallv1beta1.Application, value any, _ string) {
		...
		LookupExisting: func(ctx context.Context, _ *networkfirewallv1beta1.Application, value any) (any, error) {
			identity := value.(policychildruntime.Identity)
			return getCall(ctx, networkfirewallsdk.GetApplicationRequest{NetworkFirewallPolicyId: common.String(identity.PolicyID), ApplicationName: common.String(identity.Name)})
		},
		SeedSyntheticTrackedID: func(resource *networkfirewallv1beta1.Application, value any) func() {
	...
	nameField := policychildruntime.NameField("ApplicationName", "applicationName")
	hooks.Create.Fields = []generatedruntime.RequestField{policyField, {FieldName: "CreateApplicationDetails", Contribution: "body"}}
	...
	hooks.Update.Fields = []generatedruntime.RequestField{policyField, nameField, {FieldName: "UpdateApplicationDetails", Contribution: "body"}}
