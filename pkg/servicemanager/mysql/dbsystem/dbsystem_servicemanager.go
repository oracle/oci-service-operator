...
func (c *DbSystemServiceManager) convert(obj runtime.Object) (*mysqlv1beta1.DbSystem, error) {
	resource, ok := obj.(*mysqlv1beta1.DbSystem)
	if !ok {
		return nil, fmt.Errorf("expected *mysqlv1beta1.DbSystem, got %T", obj)
	}
	return resource, nil
}

func (c *DbSystemServiceManager) status(resource *mysqlv1beta1.DbSystem) *shared.OSOKStatus {
