...
type WorkRequestLogRuntimeHooks struct {
	...
	BuildCreateBody func(context.Context, *odav1beta1.WorkRequestLog, string) (any, error)
	...
	Async               generatedruntime.AsyncHooks[*odav1beta1.WorkRequestLog]
	DeleteHooks         generatedruntime.DeleteHooks[*odav1beta1.WorkRequestLog]
...
func newWorkRequestLogRuntimeHooks(manager *WorkRequestLogServiceManager, sdkClient odasdk.OdaClient) WorkRequestLogRuntimeHooks {
...
) generatedruntime.Config[*odav1beta1.WorkRequestLog] {
	return generatedruntime.Config[*odav1beta1.WorkRequestLog]{
		Kind:            "WorkRequestLog",
		...
		List: &generatedruntime.Operation{
			NewRequest: func() any { return &odasdk.ListWorkRequestLogsRequest{} },
			Fields:     append([]generatedruntime.RequestField(nil), hooks.List.Fields...),
			Call: func(ctx context.Context, request any) (any, error) {
				return hooks.List.Call(ctx, *request.(*odasdk.ListWorkRequestLogsRequest))
			},
		},
	}
}
