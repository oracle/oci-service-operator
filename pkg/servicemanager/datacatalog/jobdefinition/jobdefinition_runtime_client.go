...
func init() {
	registerJobDefinitionRuntimeHooksMutator(func(_ *JobDefinitionServiceManager, hooks *JobDefinitionRuntimeHooks) {
		hooks.Semantics = reviewedJobDefinitionRuntimeSemantics()
	})
}

func reviewedJobDefinitionRuntimeSemantics() *generatedruntime.Semantics {
	return &generatedruntime.Semantics{
		FormalService: "datacatalog", FormalSlug: "jobdefinition",
		...
		Mutation:       generatedruntime.MutationSemantics{Mutable: []string{"displayName", "description", "isIncremental", "dataAssetKey", "glossaryKey", "connectionKey", "isSampleDataExtracted", "sampleDataSizeInMBs", "properties"}, ForceNew: []string{"jobType", "catalogId"}, ZeroValueNullEquivalent: []string{"displayName", "description", "isIncremental", "dataAssetKey", "glossaryKey", "connectionKey", "isSampleDataExtracted", "sampleDataSizeInMBs", "properties", "jobType", "catalogId"}},
