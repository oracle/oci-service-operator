...
func TestMockIntegrationFolderCompositeCRUD(t *testing.T) {
	...
	resource.Spec = ocimock.MustJSONFixture[datacatalogv1beta1.FolderSpec](t, `{
  "catalogId": "<ocid:1>",
  ...
  "lifecycleState": "ACTIVE"
	...
	updatedState := ocimock.MustOCIResponseFixture[datacatalogsdk.Folder](t, `{
  "dataAssetKey": "asset-key",
  "displayName": "folder create",
  "timeExternal": "2026-01-02T03:04:05Z",
  "description": "updated",
  ...
  "lifecycleState": "ACTIVE"
	...
	responder, err := ocimock.NewExplicitCRUDResponder(ocimock.ExplicitCRUDOptions[datacatalogsdk.Folder, datacatalogsdk.CreateFolderDetails, datacatalogsdk.UpdateFolderDetails]{
		...
		ValidateCreate: func(request ocimock.Request, _ datacatalogsdk.CreateFolderDetails) error {
	...
	err = ocimock.RunLifecycle(context.Background(), ocimock.LifecycleScenario[*datacatalogv1beta1.Folder]{
		Resource: resource, Client: client, CreateContext: generatedruntime.WithSkipExistingBeforeCreate,
		ValidateCreated: func(current *datacatalogv1beta1.Folder) error {
		...
		Mutate: func(current *datacatalogv1beta1.Folder) { current.Spec = updatedSpec },
		ValidateUpdated: func(current *datacatalogv1beta1.Folder) error {
