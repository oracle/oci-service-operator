...
func init() {
	registerCatalogRuntimeHooksMutator(func(_ *CatalogServiceManager, hooks *CatalogRuntimeHooks) {
		hooks.Semantics = newCatalogRuntimeSemantics()
	})
}

func newCatalogRuntimeSemantics() *generatedruntime.Semantics {
