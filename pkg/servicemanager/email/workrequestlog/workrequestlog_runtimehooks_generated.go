...
type WorkRequestLogRuntimeHooks struct {
	...
	Async               generatedruntime.AsyncHooks[*emailv1beta1.WorkRequestLog]
	DeleteHooks         generatedruntime.DeleteHooks[*emailv1beta1.WorkRequestLog]
...
func newWorkRequestLogRuntimeHooks(manager *WorkRequestLogServiceManager, sdkClient emailsdk.EmailClient) WorkRequestLogRuntimeHooks {
...
) generatedruntime.Config[*emailv1beta1.WorkRequestLog] {
	return generatedruntime.Config[*emailv1beta1.WorkRequestLog]{
		Kind:            "WorkRequestLog",
		...
		List: &generatedruntime.Operation{
			...
			Call: func(ctx context.Context, request any) (any, error) {
				return hooks.List.Call(ctx, *request.(*emailsdk.ListWorkRequestLogsRequest))
			},
		},
	}
}
