...
var ReviewedAPIErrorCoverageRegistry = APIErrorCoverageRegistry{
	Registrations: mergeReviewedRegistrationSets(
		map[string]APIErrorCoverageRegistration{
			...
			resourceKey("databasemigration", "Migration"): reviewedRegistration(
				"databasemigration",
				"databasemigration",
				apiErrorCoverageDefaultVersion,
				"Migration",
				...
				deleteNotFoundReadback,
				retryableConflictWorkRequest,
				"Migration runtime persists create, update, and delete work-request OCIDs in shared async status, prefers create response-body identity when OCI returns it, recovers Migration identity from work-request resources otherwise, and rereads GetMigration after work-request completion before projecting status.",
			),
			...
			resourceKey("disasterrecovery", "DrPlan"): reviewedRegistration(
				"disasterrecovery",
				"disasterrecovery",
				apiErrorCoverageDefaultVersion,
				"DrPlan",
				...
				deleteNotFoundReadback,
				retryableConflictWorkRequest,
				"DrPlan keeps generatedruntime work-request follow-up for create and update, projects create response-body identity immediately when OCI returns it, and falls back to GetDrPlan delete confirmation rereads because DeleteDrPlan does not return a work-request OCID.",
			),
			...
			resourceKey("distributeddatabase", "DistributedDatabase"): reviewedRegistration(
				"distributeddatabase",
				"distributeddatabase",
				apiErrorCoverageDefaultVersion,
				"DistributedDatabase",
				...
				deleteNotFoundGeneratedRuntime,
				retryableConflictGeneratedRuntime,
				"DistributedDatabase keeps lifecycle-driven generatedruntime CRUD and confirm-delete rereads, while mixed create/delete work-request headers are treated as shared async breadcrumbs rather than a dedicated work-request waiter.",
			),
			...
			resourceKey("opa", "OpaInstance"): reviewedRegistration(
				"opa",
				"opa",
				apiErrorCoverageDefaultVersion,
				"OpaInstance",
				...
				deleteNotFoundReadback,
				retryableConflictWorkRequest,
				"Generated OpaInstance runtime persists create, update, and delete work-request OCIDs in shared async status, recovers OpaInstance identity from work-request resources, and normalizes create-only idcsAt drift after the first successful read.",
			),
			...
			resourceKey("jms", "JmsPlugin"): reviewedRegistration(
				"jms",
				"jms",
				apiErrorCoverageDefaultVersion,
				"JmsPlugin",
				...
				deleteNotFoundGeneratedRuntime,
				retryableConflictGeneratedRuntime,
				"JmsPlugin keeps plain generatedruntime CRUD and lifecycle rereads; create and update return the resource body directly, delete confirms through rereads, and no service-local work-request resume path is required.",
			),
		...
		map[string]APIErrorCoverageRegistration{
			...
			resourceKey("generativeaiagent", "KnowledgeBase"): reviewedRegistration(
				"generativeaiagent",
				"generativeaiagent",
				apiErrorCoverageDefaultVersion,
				"KnowledgeBase",
			...
			resourceKey("generativeaiagent", "AgentEndpoint"): reviewedRegistration(
				"generativeaiagent",
				"generativeaiagent",
				apiErrorCoverageDefaultVersion,
				"AgentEndpoint",
				...
				deleteNotFoundReadback,
				retryableConflictWorkRequest,
				"AgentEndpoint runtime persists create, update, and delete work-request IDs in shared async status, prefers create response-body identity when OCI returns it, recovers the OCID from work-request resources otherwise, and bounds pre-create reuse to exact compartmentId plus displayName matches.",
			),
			resourceKey("generativeaiagent", "DataSource"): reviewedRegistration(
				"generativeaiagent",
				"generativeaiagent",
				apiErrorCoverageDefaultVersion,
				"DataSource",
				...
				deleteNotFoundReadback,
				retryableConflictWorkRequest,
				"DataSource runtime persists create, update, and delete work-request IDs in shared async status, prefers create response-body identity when OCI returns it, recovers the OCID from work-request resources otherwise, and re-enters shared rereads after work-request completion before projecting status.",
			),
		...
		reviewedRegistrationSet(
			...
			deleteNotFoundGeneratedRuntime,
			retryableConflictGeneratedRuntime,
			"Group-C runtime review added resource-local content handling on top of generatedruntime scaffolding, including binary/secret content paths and unsupported-operation guards where the SDK surface is read or upload oriented.",
		...
		reviewedRegistrationSet(
			...
			deleteNotFoundGeneratedRuntime,
			retryableConflictGeneratedRuntime,
			"Group-C runtime review added resource-local JMS Utils lifecycle handling, including singleton configuration, async analysis work, work-item observation, and unsupported-operation guards where the SDK surface is not full CRUD.",
		...
		reviewedRegistrationSet(
			...
			deleteNotFoundGeneratedRuntime,
			retryableConflictGeneratedRuntime,
			"Group-C runtime review added resource-local Multicloud handling, including read-only metadata observation, paginated list readback, and unsupported-operation guards for list-only SDK surfaces.",
		...
		reviewedRegistrationSet(
			...
			deleteNotFoundGeneratedRuntime,
			retryableConflictGeneratedRuntime,
			"Group-C runtime review added resource-local OCI Control Center metadata observation with unsupported-operation guards for list-only metric and namespace SDK surfaces.",
			"MetricProperty",
			"Namespace",
		),
		reviewedRegistrationSet(
		...
		map[string]APIErrorCoverageRegistration{
			...
			resourceKey("wlms", "ManagedInstance"): reviewedRegistration(
				"wlms",
				"wlms",
				apiErrorCoverageDefaultVersion,
				"ManagedInstance",
				...
				deleteNotFoundManualRuntime,
				retryableConflictGeneratedRuntime,
				"ManagedInstance is bind-existing plus update-only because WLMS lacks CreateManagedInstance and DeleteManagedInstance; a handwritten wrapper validates bind identity, preflights explicit IDs through GetManagedInstance so direct binds do not fall back to list adoption, paginates ListManagedInstances lookup, preserves sparse configuration intent for UpdateManagedInstance, and treats CR delete as local unbind without OCI delete helpers.",
			),
			...
			resourceKey("tenantmanagercontrolplane", "DomainGovernance"): reviewedRegistration(
				"tenantmanagercontrolplane",
				"tenantmanagercontrolplane",
				apiErrorCoverageDefaultVersion,
				"DomainGovernance",
				...
				deleteNotFoundGeneratedRuntime,
				retryableConflictGeneratedRuntime,
				"DomainGovernance keeps plain generatedruntime CRUD and lifecycle rereads; create and update project the returned resource body directly and delete confirms through rereads without service-local work-request polling.",
			),
			...
			resourceKey("psa", "PrivateServiceAccess"): reviewedRegistration(
				...
				deleteNotFoundReadback,
				retryableConflictWorkRequest,
				"PrivateServiceAccess runtime resumes create, update, and delete through service-SDK work requests, recovers OCI identity from work-request resources or create responses, and bounds pre-create reuse to exact compartmentId plus subnetId plus serviceId plus displayName matches.",
			),
			resourceKey("vnmonitoring", "PathAnalyzerTest"): reviewedRegistration(
				"vnmonitoring",
				"vnmonitoring",
				apiErrorCoverageDefaultVersion,
				"PathAnalyzerTest",
				...
				deleteNotFoundGeneratedRuntime,
				retryableConflictFollowUp,
				"PathAnalyzerTest runtime keeps generated read-after-write follow-up on create and update, reuses only exact compartmentId plus displayName and endpoint/protocol matches, and confirms delete through generated rereads without service-local work-request tracking.",
			),
		},
		reviewedRegistrationSet(
		...
		map[string]APIErrorCoverageRegistration{
			...
			resourceKey("mediaservices", "MediaWorkflowConfiguration"): reviewedRegistration(
				"mediaservices",
				"mediaservices",
				apiErrorCoverageDefaultVersion,
				...
				deleteNotFoundGeneratedRuntime,
				retryableConflictGeneratedRuntime,
				"MediaWorkflowConfiguration keeps plain generatedruntime CRUD and lifecycle rereads; create and update project returned bodies directly, delete confirms through rereads, and no service-local work-request helper is required.",
			),
		},
		reviewedRegistrationSet(
		...
		reviewedRegistrationSet(
			...
			deleteNotFoundGeneratedRuntime,
			retryableConflictGeneratedRuntime,
			"Group-C runtime review added resource-local billing schedule observation with unsupported-operation guards for list-only subscription SDK surfaces.",
			"BillingSchedule",
		),
		reviewedRegistrationSet(
			...
			deleteNotFoundGeneratedRuntime,
			retryableConflictGeneratedRuntime,
			"Group-C runtime review added resource-local organization subscription observation with unsupported-operation guards for list-only subscription SDK surfaces.",
	...
	Exceptions: map[string]APIErrorCoverageException{
		...
		resourceKey("generativeaiagent", "DataIngestionJob"): reviewedException(
			"generativeaiagent",
			"generativeaiagent",
			apiErrorCoverageDefaultVersion,
			"DataIngestionJob",
		...
		resourceKey("generativeaiagent", "ProvisionedCapacity"): reviewedException(
			"generativeaiagent",
			"generativeaiagent",
			apiErrorCoverageDefaultVersion,
			"ProvisionedCapacity",
		...
		resourceKey("generativeaiagent", "Tool"): reviewedException(
			"generativeaiagent",
			"generativeaiagent",
			apiErrorCoverageDefaultVersion,
			"Tool",
		...
		resourceKey("generativeaiagent", "WorkRequest"): reviewedException(
			"generativeaiagent",
			"generativeaiagent",
			apiErrorCoverageDefaultVersion,
			"WorkRequest",
		...
		resourceKey("generativeaiagent", "WorkRequestError"): reviewedException(
			"generativeaiagent",
			"generativeaiagent",
			apiErrorCoverageDefaultVersion,
			"WorkRequestError",
		...
		resourceKey("generativeaiagent", "WorkRequestLog"): reviewedException(
			"generativeaiagent",
			"generativeaiagent",
			apiErrorCoverageDefaultVersion,
			"WorkRequestLog",
		...
		resourceKey("opa", "WorkRequest"): reviewedException(
			"opa",
			"opa",
			apiErrorCoverageDefaultVersion,
			"WorkRequest",
		...
		resourceKey("opa", "WorkRequestError"): reviewedException(
			"opa",
			"opa",
			apiErrorCoverageDefaultVersion,
			"WorkRequestError",
