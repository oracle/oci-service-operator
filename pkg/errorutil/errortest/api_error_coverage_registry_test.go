...
func TestCheckedInAPIErrorCoverageInventoryIncludesSelectedKindsAndExplicitExceptions(t *testing.T) {
	...
	assertInventorySelectionSource(t, byKey, "databasemigration/Migration", "selection.includeKinds")
	...
	assertInventorySelectionSource(t, byKey, "disasterrecovery/DrPlan", "selection.includeKinds")
	assertInventorySelectionSource(t, byKey, "disasterrecovery/DrProtectionGroup", "selection.includeKinds")
	assertInventorySelectionSource(t, byKey, "distributeddatabase/DistributedDatabase", "selection.includeKinds")
	...
	assertInventorySelectionSource(t, byKey, "generativeaiagent/AgentEndpoint", "selection.includeKinds")
	assertInventorySelectionSource(t, byKey, "generativeaiagent/DataSource", "selection.includeKinds")
	...
	assertInventorySelectionSource(t, byKey, "mediaservices/MediaWorkflowConfiguration", "selection.includeKinds")
	assertInventorySelectionSource(t, byKey, "mngdmac/MacOrder", "selection.includeKinds")
	...
	assertInventorySelectionSource(t, byKey, "jms/JmsPlugin", "selection.includeKinds")
	...
	assertInventorySelectionSource(t, byKey, "tenantmanagercontrolplane/DomainGovernance", "selection.includeKinds")
	...
	assertInventoryRegistration(t, byKey, "databasemigration/Migration")
	...
	assertInventoryRegistration(t, byKey, "disasterrecovery/DrPlan")
	assertInventoryRegistration(t, byKey, "disasterrecovery/DrProtectionGroup")
	assertInventoryRegistration(t, byKey, "distributeddatabase/DistributedDatabase")
	...
	assertInventoryRegistration(t, byKey, "generativeaiagent/AgentEndpoint")
	assertInventoryRegistration(t, byKey, "generativeaiagent/DataSource")
	...
	assertInventoryRegistration(t, byKey, "mediaservices/MediaWorkflowConfiguration")
	assertInventoryRegistration(t, byKey, "mngdmac/MacOrder")
	...
	assertInventoryRegistration(t, byKey, "jms/JmsPlugin")
	...
	assertInventoryRegistration(t, byKey, "tenantmanagercontrolplane/DomainGovernance")
...
func TestReviewedAPIErrorCoverageRegistryRepresentativeMappings(t *testing.T) {
	...
	assertReviewedFamily(t, "databasemigration/Migration", APIErrorCoverageFamilyGeneratedRuntimeWorkRequest)
	...
	assertReviewedFamily(t, "disasterrecovery/DrPlan", APIErrorCoverageFamilyGeneratedRuntimeWorkRequest)
	assertReviewedFamily(t, "distributeddatabase/DistributedDatabase", APIErrorCoverageFamilyGeneratedRuntimePlain)
	...
	assertReviewedFamily(t, "generativeaiagent/AgentEndpoint", APIErrorCoverageFamilyGeneratedRuntimeWorkRequest)
	assertReviewedFamily(t, "generativeaiagent/DataSource", APIErrorCoverageFamilyGeneratedRuntimeWorkRequest)
	...
	assertReviewedFamily(t, "mediaservices/MediaWorkflowConfiguration", APIErrorCoverageFamilyGeneratedRuntimePlain)
	...
	assertReviewedFamily(t, "tenantmanagercontrolplane/DomainGovernance", APIErrorCoverageFamilyGeneratedRuntimePlain)
	...
	assertReviewedFamily(t, "jms/JmsPlugin", APIErrorCoverageFamilyGeneratedRuntimePlain)
