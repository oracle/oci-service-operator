...
| `dataflow/Application` | `pkg/servicemanager/dataflow/application` | `lifecycle` | `lifecycle` | The handwritten runtime projects OCI lifecycle states directly and confirms delete through lifecycle reads. |
