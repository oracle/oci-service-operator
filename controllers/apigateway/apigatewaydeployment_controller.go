...
// +kubebuilder:rbac:groups=apigateway.oracle.com,resources=apigatewaydeployments,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apigateway.oracle.com,resources=apigatewaydeployments/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=apigateway.oracle.com,resources=apigatewaydeployments/finalizers,verbs=update
...
func (r *ApiGatewayDeploymentReconciler) SetupWithManager(mgr ctrl.Manager) error {
	builder := ctrl.NewControllerManagedBy(mgr).
		For(&apigatewayv1beta1.ApiGatewayDeployment{})
	return builder.
