...
// +kubebuilder:rbac:groups=database.oracle.com,resources=autonomouscontainerdatabases/finalizers,verbs=update
...
func (r *AutonomousContainerDatabaseReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	autonomousContainerDatabase := &databasev1beta1.AutonomousContainerDatabase{}
	return r.Reconciler.Reconcile(ctx, req, autonomousContainerDatabase)
}

// SetupWithManager sets up the controller with the Manager.
func (r *AutonomousContainerDatabaseReconciler) SetupWithManager(mgr ctrl.Manager) error {
	builder := ctrl.NewControllerManagedBy(mgr).
		For(&databasev1beta1.AutonomousContainerDatabase{})
	return builder.
