...
// PublicIpByIpAddressReconciler reconciles a PublicIpByIpAddress object.
type PublicIpByIpAddressReconciler struct {
...
func (r *PublicIpByIpAddressReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	publicIpByIpAddress := &corev1beta1.PublicIpByIpAddress{}
	return r.Reconciler.Reconcile(ctx, req, publicIpByIpAddress)
}

// SetupWithManager sets up the controller with the Manager.
func (r *PublicIpByIpAddressReconciler) SetupWithManager(mgr ctrl.Manager) error {
	builder := ctrl.NewControllerManagedBy(mgr).
		For(&corev1beta1.PublicIpByIpAddress{})
	return builder.
