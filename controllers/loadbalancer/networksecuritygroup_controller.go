...
// +kubebuilder:rbac:groups=loadbalancer.oracle.com,resources=networksecuritygroups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=loadbalancer.oracle.com,resources=networksecuritygroups/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=loadbalancer.oracle.com,resources=networksecuritygroups/finalizers,verbs=update
...
func (r *NetworkSecurityGroupReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	networkSecurityGroup := &loadbalancerv1beta1.NetworkSecurityGroup{}
...
func (r *NetworkSecurityGroupReconciler) SetupWithManager(mgr ctrl.Manager) error {
	builder := ctrl.NewControllerManagedBy(mgr).
		For(&loadbalancerv1beta1.NetworkSecurityGroup{})
	return builder.
