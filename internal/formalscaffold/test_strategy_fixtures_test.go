...
const scaffoldTestActivityStrategy = `schemaVersion: 1
family: activity
title: Activity
...
const scaffoldTestSequenceStrategy = `schemaVersion: 1
family: sequence
title: Sequence
...
const scaffoldTestStateMachineStrategy = `schemaVersion: 1
...
const scaffoldTestSharedStrategy = `schemaVersion: 1
diagrams:
...
const scaffoldTestLegendStrategy = `schemaVersion: 1
...
func writeDiagramStrategyFixtures(t *testing.T, root string) {
	t.Helper()

	writeTestFile(t, filepath.Join(root, "formal", "controller_diagrams", "activity.yaml"), scaffoldTestActivityStrategy)
	writeTestFile(t, filepath.Join(root, "formal", "controller_diagrams", "sequence.yaml"), scaffoldTestSequenceStrategy)
	writeTestFile(t, filepath.Join(root, "formal", "controller_diagrams", "state-machine.yaml"), scaffoldTestStateMachineStrategy)
	writeTestFile(t, filepath.Join(root, "formal", "controller_diagrams", "shared.yaml"), scaffoldTestSharedStrategy)
	writeTestFile(t, filepath.Join(root, "formal", "controller_diagrams", "legend.yaml"), scaffoldTestLegendStrategy)
}
