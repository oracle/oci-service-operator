...
var seedTargets = []Target{
	...
	newTarget("email", "WorkRequest", reflect.TypeOf(email.WorkRequest{})),
	newTarget("email", "WorkRequestError", reflect.TypeOf(email.WorkRequestError{})),
	newTarget("email", "WorkRequestErrorCollection", reflect.TypeOf(email.WorkRequestErrorCollection{})),
	newTarget("email", "WorkRequestLogEntry", reflect.TypeOf(email.WorkRequestLogEntry{})),
	newTarget("email", "WorkRequestLogEntryCollection", reflect.TypeOf(email.WorkRequestLogEntryCollection{})),
	...
	newTarget("email", "WorkRequestSummary", reflect.TypeOf(email.WorkRequestSummary{})),
	...
	newTarget("generativeai", "WorkRequest", reflect.TypeOf(generativeai.WorkRequest{})),
	newTarget("generativeai", "WorkRequestError", reflect.TypeOf(generativeai.WorkRequestError{})),
	newTarget("generativeai", "WorkRequestErrorCollection", reflect.TypeOf(generativeai.WorkRequestErrorCollection{})),
	newTarget("generativeai", "WorkRequestLogEntry", reflect.TypeOf(generativeai.WorkRequestLogEntry{})),
	newTarget("generativeai", "WorkRequestLogEntryCollection", reflect.TypeOf(generativeai.WorkRequestLogEntryCollection{})),
	...
	newTarget("generativeai", "WorkRequestSummary", reflect.TypeOf(generativeai.WorkRequestSummary{})),
	...
	newTarget("marketplace", "Agreement", reflect.TypeOf(marketplace.Agreement{})),
	newTarget("marketplace", "LaunchEligibility", reflect.TypeOf(marketplace.LaunchEligibility{})),
	newTarget("marketplace", "Listing", reflect.TypeOf(marketplace.Listing{})),
	newTarget("marketplace", "Publication", reflect.TypeOf(marketplace.Publication{})),
	newTarget("marketplace", "Publisher", reflect.TypeOf(marketplace.Publisher{})),
	newTarget("marketplace", "ReportCollection", reflect.TypeOf(marketplace.ReportCollection{})),
	newTarget("marketplace", "ReportTypeCollection", reflect.TypeOf(marketplace.ReportTypeCollection{})),
	newTarget("marketplace", "ThirdPartyPaidListingEligibility", reflect.TypeOf(marketplace.ThirdPartyPaidListingEligibility{})),
	newTarget("marketplace", "WorkRequest", reflect.TypeOf(marketplace.WorkRequest{})),
	newTarget("marketplace", "WorkRequestCollection", reflect.TypeOf(marketplace.WorkRequestCollection{})),
	newTarget("marketplace", "WorkRequestError", reflect.TypeOf(marketplace.WorkRequestError{})),
	newTarget("marketplace", "WorkRequestErrorCollection", reflect.TypeOf(marketplace.WorkRequestErrorCollection{})),
	newTarget("marketplace", "WorkRequestLogEntry", reflect.TypeOf(marketplace.WorkRequestLogEntry{})),
	newTarget("marketplace", "WorkRequestLogEntryCollection", reflect.TypeOf(marketplace.WorkRequestLogEntryCollection{})),
	newTarget("marketplace", "AcceptedAgreementSummary", reflect.TypeOf(marketplace.AcceptedAgreementSummary{})),
	newTarget("marketplace", "AgreementSummary", reflect.TypeOf(marketplace.AgreementSummary{})),
	newTarget("marketplace", "CategorySummary", reflect.TypeOf(marketplace.CategorySummary{})),
	newTarget("marketplace", "ListingSummary", reflect.TypeOf(marketplace.ListingSummary{})),
	newTarget("marketplace", "PublicationPackageSummary", reflect.TypeOf(marketplace.PublicationPackageSummary{})),
	newTarget("marketplace", "PublicationSummary", reflect.TypeOf(marketplace.PublicationSummary{})),
	newTarget("marketplace", "PublisherSummary", reflect.TypeOf(marketplace.PublisherSummary{})),
	newTarget("marketplace", "ReportSummary", reflect.TypeOf(marketplace.ReportSummary{})),
	newTarget("marketplace", "ReportTypeSummary", reflect.TypeOf(marketplace.ReportTypeSummary{})),
	newTarget("marketplace", "TaxSummary", reflect.TypeOf(marketplace.TaxSummary{})),
	newTarget("marketplace", "WorkRequestSummary", reflect.TypeOf(marketplace.WorkRequestSummary{})),
	...
	newTarget("ocvp", "SupportedHostShapeCollection", reflect.TypeOf(ocvp.SupportedHostShapeCollection{})),
	newTarget("ocvp", "SupportedVmwareSoftwareVersionCollection", reflect.TypeOf(ocvp.SupportedVmwareSoftwareVersionCollection{})),
	newTarget("ocvp", "WorkRequest", reflect.TypeOf(ocvp.WorkRequest{})),
	newTarget("ocvp", "WorkRequestCollection", reflect.TypeOf(ocvp.WorkRequestCollection{})),
	newTarget("ocvp", "WorkRequestError", reflect.TypeOf(ocvp.WorkRequestError{})),
	newTarget("ocvp", "WorkRequestErrorCollection", reflect.TypeOf(ocvp.WorkRequestErrorCollection{})),
	newTarget("ocvp", "WorkRequestLogEntry", reflect.TypeOf(ocvp.WorkRequestLogEntry{})),
	newTarget("ocvp", "WorkRequestLogEntryCollection", reflect.TypeOf(ocvp.WorkRequestLogEntryCollection{})),
	newTarget("ocvp", "SupportedVmwareSoftwareVersionSummary", reflect.TypeOf(ocvp.SupportedVmwareSoftwareVersionSummary{})),
	...
	newTarget("ocvp", "SupportedCommitmentSummary", reflect.TypeOf(ocvp.SupportedCommitmentSummary{})),
	newTarget("ocvp", "SupportedHostShapeSummary", reflect.TypeOf(ocvp.SupportedHostShapeSummary{})),
	...
	newTarget("oda", "UpdateDigitalAssistantParameterDetails", reflect.TypeOf(oda.UpdateDigitalAssistantParameterDetails{})),
	...
	newTarget("oda", "DigitalAssistantParameter", reflect.TypeOf(oda.DigitalAssistantParameter{})),
	newTarget("oda", "DigitalAssistantParameterCollection", reflect.TypeOf(oda.DigitalAssistantParameterCollection{})),
	...
	newTarget("oda", "WorkRequest", reflect.TypeOf(oda.WorkRequest{})),
	newTarget("oda", "WorkRequestError", reflect.TypeOf(oda.WorkRequestError{})),
	newTarget("oda", "WorkRequestLogEntry", reflect.TypeOf(oda.WorkRequestLogEntry{})),
	...
	newTarget("oda", "DigitalAssistantParameterSummary", reflect.TypeOf(oda.DigitalAssistantParameterSummary{})),
	...
	newTarget("oda", "PackageSummary", reflect.TypeOf(oda.PackageSummary{})),
	...
	newTarget("oda", "WorkRequestSummary", reflect.TypeOf(oda.WorkRequestSummary{})),
	...
	newTarget("usageapi", "ScheduledRun", reflect.TypeOf(usageapi.ScheduledRun{})),
	newTarget("usageapi", "ScheduledRunCollection", reflect.TypeOf(usageapi.ScheduledRunCollection{})),
	...
	newTarget("usageapi", "ScheduledRunSummary", reflect.TypeOf(usageapi.ScheduledRunSummary{})),
