...
func cleanupGeneratedOutputs(root string, services []ServiceConfig, packages []*PackageModel, fullSync bool) error {
	inventory, err := buildCleanupInventory(root, services, packages, fullSync)
	if err != nil {
