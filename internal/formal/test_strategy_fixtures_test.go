...
const testActivityStrategy = `schemaVersion: 1
family: activity
title: Activity
...
const testSequenceStrategy = `schemaVersion: 1
family: sequence
title: Sequence
...
const testStateMachineStrategy = `schemaVersion: 1
...
const testSharedDiagramStrategy = `schemaVersion: 1
diagrams:
...
const testLegendStrategy = `schemaVersion: 1
...
func writeControllerDiagramStrategyFixtures(t *testing.T, root string) {
	t.Helper()

	writeFile(t, filepath.Join(root, "controller_diagrams", "activity.yaml"), testActivityStrategy)
	writeFile(t, filepath.Join(root, "controller_diagrams", "sequence.yaml"), testSequenceStrategy)
	writeFile(t, filepath.Join(root, "controller_diagrams", "state-machine.yaml"), testStateMachineStrategy)
	writeFile(t, filepath.Join(root, "controller_diagrams", "shared.yaml"), testSharedDiagramStrategy)
	writeFile(t, filepath.Join(root, "controller_diagrams", "legend.yaml"), testLegendStrategy)
}
