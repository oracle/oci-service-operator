...
func TestGenerateReferenceDocsIncludesResourceGuidePages(t *testing.T) {
	t.Parallel()
	...
	for _, want := range []string{
		...
		"docs/queue.md",
		"docs/oss.md",
		"docs/guides/core/instance.md",
		"docs/guides/objectstorage/bucket.md",
	} {
		if !containsString(result.Written, want) {
			t.Fatalf("generated outputs do not include %q", want)
		}
	}
}
