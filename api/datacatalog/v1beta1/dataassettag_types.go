...
type DataAssetTagStatus struct {
...
// +kubebuilder:printcolumn:name="Status",type="string",JSONPath=".status.status.conditions[-1].type",description="status of the DataAssetTag",priority=0
// +kubebuilder:printcolumn:name="Ocid",type="string",JSONPath=".status.status.ocid",description="Ocid of the DataAssetTag",priority=1
...
type DataAssetTag struct {
	...
	Spec   DataAssetTagSpec   `json:"spec,omitempty"`
	Status DataAssetTagStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true
// DataAssetTagList contains a list of DataAssetTag.
type DataAssetTagList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []DataAssetTag `json:"items"`
}

func init() {
	SchemeBuilder.Register(&DataAssetTag{}, &DataAssetTagList{})
}
