...
type ListenerRuleRuleRedirectUri struct {
...
type ListenerRuleRule struct {
	...
	Conditions []ListenerRuleRuleCondition `json:"conditions,omitempty"`
	...
	RedirectUri  ListenerRuleRuleRedirectUri `json:"redirectUri,omitempty"`
...
type ListenerRuleStatus struct {
	...
	Rule ListenerRuleRule `json:"rule,omitempty"`
