...
type DigitalAssistantSpec struct {
...
type DigitalAssistantStatus struct {
...
// +kubebuilder:printcolumn:name="Status",type="string",JSONPath=".status.status.conditions[-1].type",description="status of the DigitalAssistant",priority=0
// +kubebuilder:printcolumn:name="Ocid",type="string",JSONPath=".status.status.ocid",description="Ocid of the DigitalAssistant",priority=1
...
type DigitalAssistant struct {
	...
	Spec   DigitalAssistantSpec   `json:"spec,omitempty"`
	Status DigitalAssistantStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true
// DigitalAssistantList contains a list of DigitalAssistant.
...
func init() {
	SchemeBuilder.Register(&DigitalAssistant{}, &DigitalAssistantList{})
}
