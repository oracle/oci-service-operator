...
// CloudAutonomousVmClusterResourceUsageSpec defines the desired state of CloudAutonomousVmClusterResourceUsage.
type CloudAutonomousVmClusterResourceUsageSpec struct {
}

// CloudAutonomousVmClusterResourceUsageAutonomousVmResourceUsageAutonomousContainerDatabaseUsage defines nested fields for CloudAutonomousVmClusterResourceUsage.AutonomousVmResourceUsage.AutonomousContainerDatabaseUsage.
type CloudAutonomousVmClusterResourceUsageAutonomousVmResourceUsageAutonomousContainerDatabaseUsage struct {
...
// CloudAutonomousVmClusterResourceUsageAutonomousVmResourceUsage defines nested fields for CloudAutonomousVmClusterResourceUsage.AutonomousVmResourceUsage.
type CloudAutonomousVmClusterResourceUsageAutonomousVmResourceUsage struct {
	...
	AutonomousContainerDatabaseUsage []CloudAutonomousVmClusterResourceUsageAutonomousVmResourceUsageAutonomousContainerDatabaseUsage `json:"autonomousContainerDatabaseUsage,omitempty"`
}

// CloudAutonomousVmClusterResourceUsageStatus defines the observed state of CloudAutonomousVmClusterResourceUsage.
type CloudAutonomousVmClusterResourceUsageStatus struct {
	...
	AutonomousVmResourceUsage []CloudAutonomousVmClusterResourceUsageAutonomousVmResourceUsage `json:"autonomousVmResourceUsage,omitempty"`
}

// +kubebuilder:object:root=true
// +kubebuilder:subresource:status
// +kubebuilder:printcolumn:name="Status",type="string",JSONPath=".status.status.conditions[-1].type",description="status of the CloudAutonomousVmClusterResourceUsage",priority=0
// +kubebuilder:printcolumn:name="Ocid",type="string",JSONPath=".status.status.ocid",description="Ocid of the CloudAutonomousVmClusterResourceUsage",priority=1
// +kubebuilder:printcolumn:name="Age",type="date",JSONPath=".metadata.creationTimestamp",priority=0
// CloudAutonomousVmClusterResourceUsage is the Schema for the cloudautonomousvmclusterresourceusages API.
type CloudAutonomousVmClusterResourceUsage struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   CloudAutonomousVmClusterResourceUsageSpec   `json:"spec,omitempty"`
	Status CloudAutonomousVmClusterResourceUsageStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true
// CloudAutonomousVmClusterResourceUsageList contains a list of CloudAutonomousVmClusterResourceUsage.
type CloudAutonomousVmClusterResourceUsageList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []CloudAutonomousVmClusterResourceUsage `json:"items"`
}

func init() {
	SchemeBuilder.Register(&CloudAutonomousVmClusterResourceUsage{}, &CloudAutonomousVmClusterResourceUsageList{})
}
