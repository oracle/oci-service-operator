...
It records the published WorkRequestError API shape for containerengine, but it
does not imply `formalSpec`, controller-backed runtime ownership, or
publication of the standalone `workrequests` package.
