...
service: opsi
slug: chargebackplanreport
gaps:
  - category: seed-corpus
    status: open
    stopCondition: "Close when Terraform provider resource documentation exists for ChargebackPlanReport, or the generator accepts reviewed SDK/runtime mutability evidence without a Terraform documentation page."
---
...
ChargebackPlanReport resource page for deterministic mutability generation.
