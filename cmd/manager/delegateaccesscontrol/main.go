...
func init() {
	...
	utilruntime.Must(delegateaccesscontrolv1beta1.AddToScheme(scheme))
}

func main() {
	if err := manager.Run(manager.Options{
		Scheme:             scheme,
		MetricsServiceName: "delegateaccesscontrol",
		LeaderElectionID:   "40558063.oci.delegateaccesscontrol",
		SkipFIPS:           true,
	}, managerservices.ForGroup("delegateaccesscontrol")); err != nil {
		os.Exit(1)
	}
}
