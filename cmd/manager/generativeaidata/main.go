...
func init() {
	...
	utilruntime.Must(generativeaidatav1beta1.AddToScheme(scheme))
}

func main() {
	if err := manager.Run(manager.Options{
		Scheme:             scheme,
		MetricsServiceName: "generativeaidata",
		LeaderElectionID:   "40558063.oci.generativeaidata",
		SkipFIPS:           true,
	}, managerservices.ForGroup("generativeaidata")); err != nil {
		os.Exit(1)
	}
}
