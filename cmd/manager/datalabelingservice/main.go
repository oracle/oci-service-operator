...
func init() {
	...
	utilruntime.Must(datalabelingservicev1beta1.AddToScheme(scheme))
}

func main() {
	if err := manager.Run(manager.Options{
		Scheme:             scheme,
		MetricsServiceName: "datalabelingservice",
		LeaderElectionID:   "40558063.oci.datalabelingservice",
		SkipFIPS:           true,
	}, managerservices.ForGroup("datalabelingservice")); err != nil {
		os.Exit(1)
	}
}
