...
func init() {
	...
	utilruntime.Must(distributeddatabasev1beta1.AddToScheme(scheme))
}

func main() {
	if err := manager.Run(manager.Options{
		Scheme:             scheme,
		MetricsServiceName: "distributeddatabase",
		LeaderElectionID:   "40558063.oci.distributeddatabase",
		SkipFIPS:           true,
	}, managerservices.ForGroup("distributeddatabase")); err != nil {
		os.Exit(1)
	}
}
