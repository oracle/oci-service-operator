...
func init() {
	...
	utilruntime.Must(aidocumentv1beta1.AddToScheme(scheme))
}

func main() {
	if err := manager.Run(manager.Options{
		Scheme:             scheme,
		MetricsServiceName: "aidocument",
		LeaderElectionID:   "40558063.oci.aidocument",
		SkipFIPS:           true,
	}, managerservices.ForGroup("aidocument")); err != nil {
		os.Exit(1)
	}
}
