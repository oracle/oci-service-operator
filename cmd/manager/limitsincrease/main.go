...
func init() {
	...
	utilruntime.Must(limitsincreasev1beta1.AddToScheme(scheme))
}

func main() {
	if err := manager.Run(manager.Options{
		Scheme:             scheme,
		MetricsServiceName: "limitsincrease",
		LeaderElectionID:   "40558063.oci.limitsincrease",
		SkipFIPS:           true,
	}, managerservices.ForGroup("limitsincrease")); err != nil {
		os.Exit(1)
	}
}
