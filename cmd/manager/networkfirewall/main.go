...
func init() {
	...
	utilruntime.Must(networkfirewallv1beta1.AddToScheme(scheme))
}

func main() {
	if err := manager.Run(manager.Options{
		Scheme:             scheme,
		MetricsServiceName: "networkfirewall",
		LeaderElectionID:   "40558063.oci.networkfirewall",
		SkipFIPS:           true,
	}, managerservices.ForGroup("networkfirewall")); err != nil {
		os.Exit(1)
	}
}
