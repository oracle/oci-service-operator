...
func init() {
	...
	utilruntime.Must(analyticsv1beta1.AddToScheme(scheme))
}

func main() {
	if err := manager.Run(manager.Options{
		Scheme:             scheme,
		MetricsServiceName: "analytics",
		LeaderElectionID:   "40558063.oci.analytics",
		SkipFIPS:           true,
	}, managerservices.ForGroup("analytics")); err != nil {
		os.Exit(1)
	}
}
