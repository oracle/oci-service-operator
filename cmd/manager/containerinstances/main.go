...
func init() {
	...
	utilruntime.Must(containerinstancesv1beta1.AddToScheme(scheme))
}

func main() {
	if err := manager.Run(manager.Options{
		Scheme:             scheme,
		MetricsServiceName: "containerinstances",
		LeaderElectionID:   "40558063.oci.containerinstances",
		SkipFIPS:           true,
	}, managerservices.ForGroup("containerinstances")); err != nil {
		os.Exit(1)
	}
}
