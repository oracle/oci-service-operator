...
func init() {
	...
	utilruntime.Must(mediaservicesv1beta1.AddToScheme(scheme))
}

func main() {
	if err := manager.Run(manager.Options{
		Scheme:             scheme,
		MetricsServiceName: "mediaservices",
		LeaderElectionID:   "40558063.oci.mediaservices",
		SkipFIPS:           true,
	}, managerservices.ForGroup("mediaservices")); err != nil {
		os.Exit(1)
	}
}
