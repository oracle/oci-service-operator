...
func init() {
	...
	utilruntime.Must(fleetsoftwareupdatev1beta1.AddToScheme(scheme))
}

func main() {
	if err := manager.Run(manager.Options{
		Scheme:             scheme,
		MetricsServiceName: "fleetsoftwareupdate",
		LeaderElectionID:   "40558063.oci.fleetsoftwareupdate",
		SkipFIPS:           true,
	}, managerservices.ForGroup("fleetsoftwareupdate")); err != nil {
		os.Exit(1)
	}
}
