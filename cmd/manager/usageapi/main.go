...
func init() {
	...
	utilruntime.Must(usageapiv1beta1.AddToScheme(scheme))
}

func main() {
	if err := manager.Run(manager.Options{
		Scheme:             scheme,
		MetricsServiceName: "usageapi",
		LeaderElectionID:   "40558063.oci.usageapi",
		SkipFIPS:           true,
	}, managerservices.ForGroup("usageapi")); err != nil {
		os.Exit(1)
	}
}
