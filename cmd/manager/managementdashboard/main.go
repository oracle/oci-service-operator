...
func init() {
	...
	utilruntime.Must(managementdashboardv1beta1.AddToScheme(scheme))
}

func main() {
	if err := manager.Run(manager.Options{
		Scheme:             scheme,
		MetricsServiceName: "managementdashboard",
		LeaderElectionID:   "40558063.oci.managementdashboard",
		SkipFIPS:           true,
	}, managerservices.ForGroup("managementdashboard")); err != nil {
		os.Exit(1)
	}
}
