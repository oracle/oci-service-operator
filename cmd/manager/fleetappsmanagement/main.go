...
func init() {
	...
	utilruntime.Must(fleetappsmanagementv1beta1.AddToScheme(scheme))
}

func main() {
	if err := manager.Run(manager.Options{
		Scheme:             scheme,
		MetricsServiceName: "fleetappsmanagement",
		LeaderElectionID:   "40558063.oci.fleetappsmanagement",
		SkipFIPS:           true,
	}, managerservices.ForGroup("fleetappsmanagement")); err != nil {
		os.Exit(1)
	}
}
