...
func init() {
	...
	utilruntime.Must(artifactsv1beta1.AddToScheme(scheme))
}

func main() {
	if err := manager.Run(manager.Options{
		Scheme:             scheme,
		MetricsServiceName: "artifacts",
		LeaderElectionID:   "40558063.oci.artifacts",
		SkipFIPS:           true,
	}, managerservices.ForGroup("artifacts")); err != nil {
		os.Exit(1)
	}
}
