...
func init() {
	...
	utilruntime.Must(apmcontrolplanev1beta1.AddToScheme(scheme))
}

func main() {
	if err := manager.Run(manager.Options{
		Scheme:             scheme,
		MetricsServiceName: "apmcontrolplane",
		LeaderElectionID:   "40558063.oci.apmcontrolplane",
		SkipFIPS:           true,
	}, managerservices.ForGroup("apmcontrolplane")); err != nil {
		os.Exit(1)
	}
}
