...
func init() {
	...
	utilruntime.Must(osmanagementhubv1beta1.AddToScheme(scheme))
}

func main() {
	if err := manager.Run(manager.Options{
		Scheme:             scheme,
		MetricsServiceName: "osmanagementhub",
		LeaderElectionID:   "40558063.oci.osmanagementhub",
		SkipFIPS:           true,
	}, managerservices.ForGroup("osmanagementhub")); err != nil {
		os.Exit(1)
	}
}
