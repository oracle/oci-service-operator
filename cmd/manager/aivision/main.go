...
func init() {
	...
	utilruntime.Must(aivisionv1beta1.AddToScheme(scheme))
}

func main() {
	if err := manager.Run(manager.Options{
		Scheme:             scheme,
		MetricsServiceName: "aivision",
		LeaderElectionID:   "40558063.oci.aivision",
		SkipFIPS:           true,
	}, managerservices.ForGroup("aivision")); err != nil {
		os.Exit(1)
	}
}
