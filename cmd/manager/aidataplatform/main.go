...
func init() {
	...
	utilruntime.Must(aidataplatformv1beta1.AddToScheme(scheme))
}

func main() {
	if err := manager.Run(manager.Options{
		Scheme:             scheme,
		MetricsServiceName: "aidataplatform",
		LeaderElectionID:   "40558063.oci.aidataplatform",
		SkipFIPS:           true,
	}, managerservices.ForGroup("aidataplatform")); err != nil {
		os.Exit(1)
	}
}
