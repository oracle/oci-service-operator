...
func init() {
	...
	utilruntime.Must(operatoraccesscontrolv1beta1.AddToScheme(scheme))
}

func main() {
	if err := manager.Run(manager.Options{
		Scheme:             scheme,
		MetricsServiceName: "operatoraccesscontrol",
		LeaderElectionID:   "40558063.oci.operatoraccesscontrol",
		SkipFIPS:           true,
	}, managerservices.ForGroup("operatoraccesscontrol")); err != nil {
		os.Exit(1)
	}
}
