...
func init() {
	...
	utilruntime.Must(dataintegrationv1beta1.AddToScheme(scheme))
}

func main() {
	if err := manager.Run(manager.Options{
		Scheme:             scheme,
		MetricsServiceName: "dataintegration",
		LeaderElectionID:   "40558063.oci.dataintegration",
		SkipFIPS:           true,
	}, managerservices.ForGroup("dataintegration")); err != nil {
		os.Exit(1)
	}
}
