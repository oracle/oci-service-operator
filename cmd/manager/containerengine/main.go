...
func init() {
	...
	utilruntime.Must(containerenginev1beta1.AddToScheme(scheme))
}

func main() {
	if err := manager.Run(manager.Options{
		Scheme:             scheme,
		MetricsServiceName: "containerengine",
		LeaderElectionID:   "40558063.oci.containerengine",
		SkipFIPS:           true,
	}, managerservices.ForGroup("containerengine")); err != nil {
		os.Exit(1)
	}
}
