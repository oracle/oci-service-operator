...
func init() {
	...
	utilruntime.Must(appmgmtcontrolv1beta1.AddToScheme(scheme))
}

func main() {
	if err := manager.Run(manager.Options{
		Scheme:             scheme,
		MetricsServiceName: "appmgmtcontrol",
		LeaderElectionID:   "40558063.oci.appmgmtcontrol",
		SkipFIPS:           true,
	}, managerservices.ForGroup("appmgmtcontrol")); err != nil {
		os.Exit(1)
	}
}
