...
func init() {
	...
	utilruntime.Must(desktopsv1beta1.AddToScheme(scheme))
}

func main() {
	if err := manager.Run(manager.Options{
		Scheme:             scheme,
		MetricsServiceName: "desktops",
		LeaderElectionID:   "40558063.oci.desktops",
		SkipFIPS:           true,
	}, managerservices.ForGroup("desktops")); err != nil {
		os.Exit(1)
	}
}
