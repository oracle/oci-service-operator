...
func init() {
	...
	utilruntime.Must(visualbuilderv1beta1.AddToScheme(scheme))
}

func main() {
	if err := manager.Run(manager.Options{
		Scheme:             scheme,
		MetricsServiceName: "visualbuilder",
		LeaderElectionID:   "40558063.oci.visualbuilder",
		SkipFIPS:           true,
	}, managerservices.ForGroup("visualbuilder")); err != nil {
		os.Exit(1)
	}
}
