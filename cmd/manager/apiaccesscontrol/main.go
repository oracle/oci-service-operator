...
func init() {
	...
	utilruntime.Must(apiaccesscontrolv1beta1.AddToScheme(scheme))
}

func main() {
	if err := manager.Run(manager.Options{
		Scheme:             scheme,
		MetricsServiceName: "apiaccesscontrol",
		LeaderElectionID:   "40558063.oci.apiaccesscontrol",
		SkipFIPS:           true,
	}, managerservices.ForGroup("apiaccesscontrol")); err != nil {
		os.Exit(1)
	}
}
