...
func init() {
	...
	utilruntime.Must(mngdmacv1beta1.AddToScheme(scheme))
}

func main() {
	if err := manager.Run(manager.Options{
		Scheme:             scheme,
		MetricsServiceName: "mngdmac",
		LeaderElectionID:   "40558063.oci.mngdmac",
		SkipFIPS:           true,
	}, managerservices.ForGroup("mngdmac")); err != nil {
		os.Exit(1)
	}
}
