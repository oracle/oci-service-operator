...
func init() {
	...
	utilruntime.Must(licensemanagerv1beta1.AddToScheme(scheme))
}

func main() {
	if err := manager.Run(manager.Options{
		Scheme:             scheme,
		MetricsServiceName: "licensemanager",
		LeaderElectionID:   "40558063.oci.licensemanager",
		SkipFIPS:           true,
	}, managerservices.ForGroup("licensemanager")); err != nil {
		os.Exit(1)
	}
}
