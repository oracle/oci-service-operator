...
func init() {
	...
	utilruntime.Must(resourcemanagerv1beta1.AddToScheme(scheme))
}

func main() {
	if err := manager.Run(manager.Options{
		Scheme:             scheme,
		MetricsServiceName: "resourcemanager",
		LeaderElectionID:   "40558063.oci.resourcemanager",
		SkipFIPS:           true,
	}, managerservices.ForGroup("resourcemanager")); err != nil {
		os.Exit(1)
	}
}
